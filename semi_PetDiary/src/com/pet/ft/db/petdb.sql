...
INSERT INTO MEMBER
VALUES(MEMBER_SEQ.NEXTVAL, '지현', 'jihyeon1', '123456', 'jj@a.com', '010-2222-2222', 'USER', '경기도 고양시 토당동');

------------ Profile

DROP TABLE PROFILE;
CREATE TABLE PROFILE(
	PROFILE_SRC VARCHAR2(1000),
	PROFILE_STATE VARCHAR2(500),
...
CREATE TABLE CALENDAR(
	...
	CALENDAR_STARTDATE VARCHAR2(100) NOT NULL,
	CALENDAR_ENDDATE VARCHAR2(100) NOT NULL,
...
CREATE TABLE PET(
	...
	MEMBER_NO NUMBER,
	PET_PATH VARCHAR2(1000) NOT NULL,
...
CREATE TABLE ORDERINFO(
	ORDERINFO_NO NUMBER PRIMARY KEY,
	MERCHANT_UID VARCHAR2(1000) NOT NULL,
	ORDER_DATE VARCHAR2(100) NOT NULL,
	ORDER_STATE VARCHAR2(100) NOT NULL,
	ORDER_INFORMATION VARCHAR2(500) NOT NULL,
	ORDER_AMOUNT NUMBER NOT NULL,
	MEMBER_NO NUMBER NOT NULL,
	MEMBER_NAME VARCHAR2(100) NOT NULL,
	BOOK_NUM NUMBER NOT NULL,
	CONSTRAINT FK_MEMBERNO FOREIGN KEY(MEMBER_NO) REFERENCES MEMBER(MEMBER_NO),
	CONSTRAINT FK_BOOKNUM FOREIGN KEY(BOOK_NUM) REFERENCES BOOK(BOOK_NUM)
);